...
rustPlatform.buildRustPackage rec {
  pname = "wezterm";
  version = "20240203-110809-5046fc22-unstable-2025-03-07";

  src = fetchFromGitHub {
    owner = "wez";
    repo = "wezterm";
    rev = "622e404be29f861589067d109bd16b643acee2c8";
    hash = "sha256-8riFipXYk3aVqAEZP/mhGLTZDDIuG06VhyCrYiX4sHI=";
